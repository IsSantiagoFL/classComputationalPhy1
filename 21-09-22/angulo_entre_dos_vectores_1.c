...
int main()
{
	...
	*/
	...
	printf("\nEl producto escalar del vector A con el vector B es: %.2f\n",prod_esc);
	
	//Calculando el angulo entre dos vectores.
	coc=prod_esc/(mod_A*mod_B);
	ang=acos(coc)*180/3.1416;
	printf("\nEl angulo entre los vectores A y B es %.2f\n",ang);
}
